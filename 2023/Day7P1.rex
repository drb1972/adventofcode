...
analizar_jugada:
   ...
   select
      when temp = ''   then jugada = 1
      when temp = '2'  then jugada = 2
      when temp = '22' then jugada = 3
      when temp = '3'  then jugada = 4
      when temp = '23' | temp = '32' then jugada = 5
      when temp = '4'  then jugada = 6
...
init:
   ...
   */
   ...
   valor = 'A K Q J T 9 8 7 6 5 4 3 2'
   valor.0   = words(valor)
   do i = 1 to valor.0
